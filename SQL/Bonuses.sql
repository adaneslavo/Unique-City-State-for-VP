...
SELECT 'TXT_KEY_CSTRAIT_MINOR_CIV_IRUNEA', 				'[COLOR_MAGENTA]Bizkaia:[ENDCOLOR] [NEWLINE]' UNION ALL
...
INSERT INTO Resources 
			(Type,						TechReveal,		TechCityTrade, 			Description,						Civilopedia, 							Help,										ResourceClassType, 			IsMonopoly, 	ArtDefineTag, 						CivilizationType,		OnlyMinorCivs,  Happiness,  ResourceUsage, SeaResource,	AnimalResource,	PlantResouce,	RockResource,	IconString, 				PortraitIndex, 	IconAtlas)
