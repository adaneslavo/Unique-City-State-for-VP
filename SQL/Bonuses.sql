...
SELECT 'TXT_KEY_CSTRAIT_MINOR_CIV_HANUABADA', 			'[COLOR_MAGENTA]Hiri Trade Cycles:[ENDCOLOR] Land Units gain [COLOR_WATER_TEXT]Papuan Seafaring Prowess[ENDCOLOR] promotion (+2 [ICON_VP_VISION] Sight and +50%[ICON_STRENGTH]Defensive CS if unit [COLOR:255:230:85:255]is Embarked[ENDCOLOR]).[NEWLINE]' UNION ALL
...
SELECT 		'MINOR_CIV_HANUABADA', 		'FLAVOR_GOLD',				1;
...
SELECT 		'PLAYER_EVENT_CHOICE_MINOR_CIV_HANUABADA', 		'TXT_KEY_CITYSTATE_HANUABADA', 		'TXT_KEY_CSTRAIT_MINOR_CIV_HANUABADA', 		3, 				1, 			0,					NULL, 					'PROMOTION_HANUABADA', 		NULL UNION ALL
