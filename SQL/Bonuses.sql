...
SELECT 'TXT_KEY_CSTRAIT_MINOR_CIV_BRUSSELS', 			'[COLOR_MAGENTA]Home of the Marsh:[ENDCOLOR] [COLOR_CITY_GREEN]Marshes[ENDCOLOR] gain +1 [ICON_GOLD] Gold and +1 [ICON_CULTURE] Culture. Player can build [COLOR_CITY_GREEN]Marshes[ENDCOLOR] on coastal tiles, increasing the [ICON_FOOD] Food output. [COLOR_YIELD_GOLD]Land Units[ENDCOLOR] gain [COLOR_WATER_TEXT]Watringue[ENDCOLOR] promotion (Bonus[ICON_MOVES]Movement Point[COLOR:255:230:85:255] after crossing Rivers[ENDCOLOR]. Double[ICON_MOVES]Movement [COLOR:255:230:85:255]on Marsh[ENDCOLOR])[NEWLINE]' UNION ALL
...
--SELECT 'TXT_KEY_PROMOTION_BRUSSELS_VS', 				'Counter Marsh Invisibility' UNION ALL
--SELECT 'TXT_KEY_PROMOTION_BRUSSELS_VS_HELP', 				'Unit can see invisible units on Marshes.' UNION ALL
...
--SELECT 		'PROMOTION_BRUSSELS_VS', 					'TXT_KEY_PROMOTION_BRUSSELS_VS', 			'TXT_KEY_PROMOTION_BRUSSELS_VS_HELP', 			1, 				'AS2D_IF_LEVELUP', 	0, 				'UCS_PROMOTION_ATLAS', 	'PEDIA_SCOUTING', 	'TXT_KEY_PROMOTION_BRUSSELS_VS' UNION ALL
...
/*UPDATE UnitPromotions SET Invisible = 'INVISIBLE_BRUSSELS' WHERE Type = 'PROMOTION_BRUSSELS';*/
--UPDATE UnitPromotions SET SeeInvisible = 'INVISIBLE_BRUSSELS' WHERE Type = 'PROMOTION_BRUSSELS_VS';
...
--SELECT 		'PROMOTION_BRUSSELS', 				'UNITCOMBAT_GUN' UNION ALL
--SELECT 		'PROMOTION_BRUSSELS_VS', 			'UNITCOMBAT_RECON' UNION ALL
...
/*INSERT INTO InvisibleInfos
			(Type, 					Description)
SELECT 		'INVISIBLE_BRUSSELS', 	'TXT_KEY_PROMOTION_BRUSSELS';*/
---------------------------------------------------
