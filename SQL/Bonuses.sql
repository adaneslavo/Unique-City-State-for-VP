...
SELECT 'TXT_KEY_CIV5_LONGYAN_TEXT', 						'TODO';
...
SELECT 'TXT_KEY_CSTRAIT_MINOR_CIV_JUYUBIT', 			'[COLOR_MAGENTA]Brotherhood of the Canoe:[ENDCOLOR] [COLOR_GREY]Fish[ENDCOLOR] gain +1 Food. [COLOR_GREY]Bonus Resources[ENDCOLOR] gain +1 Science. Player can train [COLOR_YIELD_GOLD]Te''aat[ENDCOLOR] unit (unique [COLOR_YIELD_GOLD]Workboat[ENDCOLOR]).[NEWLINE]' UNION ALL
...
SELECT 'TXT_KEY_CSTRAIT_MINOR_CIV_LONGYAN', 			'[COLOR_MAGENTA]Home of Generals:[ENDCOLOR] Player can build a [COLOR_CITY_BROWN]Tulou[ENDCOLOR] improvement on hill next to a City, increasing your [ICON_FOOD] Food, [ICON_PRODUCTION] Production, [ICON_CULTURE] Culture, [ICON_GREAT_GENERAL] Great General Point output and your [ICON_SILVER_FIST] Supply Cap. Units gain +30% [ICON_STRENGTH] Defensive CS, when on a [COLOR_CITY_BROWN]Tulou[ENDCOLOR].[NEWLINE]' UNION ALL
...
SELECT 'TXT_KEY_CSTRAIT_MINOR_CIV_MANAGUA', 			'[COLOR_MAGENTA]Place of the Big Man:[ENDCOLOR] Player gains +1 [ICON_SPY] Spy. +20 [ICON_CULTURE] Culture when you successfully complete a [ICON_SPY] Spy Mission in a foreign City, scaling with Era.[NEWLINE]' UNION ALL
...
SELECT 'TXT_KEY_CSTRAIT_MINOR_CIV_SANAA', 				'[COLOR_MAGENTA]Arabia Felix:[ENDCOLOR] Capital gains +1 Gold for each different Luxury Resource improved by the Player (traded or imported Luxury Resources do not count). Each currently applied percentage-based Global Monopoly modifier gains an additional +5% bonus.[NEWLINE]' UNION ALL
...
SELECT 		'MINOR_CIV_LONGYAN', 		'FLAVOR_GROWTH',			1;
---------------------------------------------------
...
SELECT 		'PLAYER_EVENT_CHOICE_MINOR_CIV_MANAGUA', 		'TXT_KEY_CSTRAIT_MINOR_CIV', 	'TXT_KEY_CSTRAIT_MINOR_CIV_MANAGUA', 		3, 				1, 			0,					NULL, 					NULL, 						NULL UNION ALL
...
VALUES 		('Any', 'Constructed', 			0.65, 	'ART_DEF_IMPROVEMENT_SUNK_COURT', 	'RANDOM', 		'ART_DEF_RESOURCE_NONE',			'chatallata_6.fxsxml',				1),
			...
			('Any', 'UnderConstruction', 	1, 		'ART_DEF_IMPROVEMENT_TULOU', 		'RANDOM', 		'ART_DEF_RESOURCE_NONE',			'TULOU_HB.fxsxml',					1),
			('Any', 'Constructed', 			1, 		'ART_DEF_IMPROVEMENT_TULOU', 		'RANDOM', 		'ART_DEF_RESOURCE_NONE',			'TULOU.fxsxml',						1),
			('Any', 'Pillaged', 			1, 		'ART_DEF_IMPROVEMENT_TULOU', 		'RANDOM', 		'ART_DEF_RESOURCE_NONE',			'TULOU_PL.fxsxml',					1);
