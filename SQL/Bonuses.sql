...
SELECT 'TXT_KEY_CSTRAIT_MINOR_CIV_SANANDAJ', 			'[COLOR_MAGENTA]Gorani Literature:[ENDCOLOR] Training a Diplomatic Unit grants 15-25 [ICON_CULTURE] Culture in Capital, scaling with Era. Each Era change grants a free [COLOR_YIELD_GOLD]Envoy[ENDCOLOR] in your Capital.[NEWLINE]' UNION ALL
SELECT 'TXT_KEY_CSTRAIT_MINOR_CIV_BAGHCASARAY', 		'[COLOR_MAGENTA]Desht-i-Kipchak Successors:[ENDCOLOR] [COLOR_YIELD_GOLD]Mounted and Armored Units[ENDCOLOR] gain [COLOR_WATER_TEXT]Yesir Captives[ENDCOLOR] promotion (Unit has 10% chance to add 1 [ICON_CITIZEN] Citizen to the nearest City [COLOR:255:230:85:255]on Kill[ENDCOLOR]).[NEWLINE]' UNION ALL
