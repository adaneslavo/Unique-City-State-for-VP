...
SELECT 		'MINOR_CIV_VADUZ', 				'TXT_KEY_CITYSTATE_VADUZ', 				'TXT_KEY_CIV5_VADUZ_TEXT', 				'TXT_KEY_CITYSTATE_VADUZ', 				'TXT_KEY_CITYSTATE_VADUZ_ADJ', 				'ART_DEF_CIVILIZATION_MINOR', 	'PLAYERCOLOR_MINOR_GREEN', 			'ARTSTYLE_EUROPEAN', 		'_EURO', 			'EUROPEAN', 		'MINOR_TRAIT_CULTURED',			NULL,				'UNITCLASS_WORKER' UNION ALL
SELECT 		'MINOR_CIV_MATONJENI', 			'TXT_KEY_CITYSTATE_MATONJENI', 			'TXT_KEY_CIV5_MATONJENI_TEXT', 			'TXT_KEY_CITYSTATE_MATONJENI', 			'TXT_KEY_CITYSTATE_MATONJENI_ADJ', 			'ART_DEF_CIVILIZATION_MINOR', 	'PLAYERCOLOR_MINOR_YELLOW', 		'ARTSTYLE_MIDDLE_EAST', 	'_AFRI', 			'AFRICAN', 			'MINOR_TRAIT_RELIGIOUS',		NULL,				'UNITCLASS_WORKER' UNION ALL
SELECT 		'MINOR_CIV_NGAZARGAMU', 		'TXT_KEY_CITYSTATE_NGAZARGAMU', 		'TXT_KEY_CIV5_NGAZARGAMU_TEXT', 		'TXT_KEY_CITYSTATE_NGAZARGAMU', 		'TXT_KEY_CITYSTATE_NGAZARGAMU_ADJ', 		'ART_DEF_CIVILIZATION_MINOR', 	'PLAYERCOLOR_MINOR_LIGHT_PURPLE', 	'ARTSTYLE_MIDDLE_EAST', 	'_AFRI', 			'AFRICAN', 			'MINOR_TRAIT_RELIGIOUS',		NULL,				'UNITCLASS_WORKER' UNION ALL
SELECT 		'MINOR_CIV_KAGYRGYN', 			'TXT_KEY_CITYSTATE_KAGYRGYN', 			'TXT_KEY_CIV5_KAGYRGYN_TEXT', 			'TXT_KEY_CITYSTATE_KAGYRGYN', 			'TXT_KEY_CITYSTATE_KAGYRGYN_ADJ', 			'ART_DEF_CIVILIZATION_MINOR', 	'PLAYERCOLOR_MINOR_PEACH', 			'ARTSTYLE_ASIAN', 			'_ASIA', 			'ASIAN', 			'MINOR_TRAIT_MARITIME',			NULL,				'UNITCLASS_WORKER' UNION ALL
SELECT 		'MINOR_CIV_BALLEY_CHASHTAL', 	'TXT_KEY_CITYSTATE_BALLEY_CHASHTAL', 	'TXT_KEY_CIV5_BALLEY_CHASHTAL_TEXT', 	'TXT_KEY_CITYSTATE_BALLEY_CHASHTAL', 	'TXT_KEY_CITYSTATE_BALLEY_CHASHTAL_ADJ', 	'ART_DEF_CIVILIZATION_MINOR', 	'PLAYERCOLOR_MINOR_CYAN', 			'ARTSTYLE_EUROPEAN', 		'_EURO', 			'EUROPEAN', 		'MINOR_TRAIT_MARITIME',			NULL,				'UNITCLASS_WORKER' UNION ALL
SELECT 		'MINOR_CIV_SANANDAJ', 			'TXT_KEY_CITYSTATE_SANANDAJ', 			'TXT_KEY_CIV5_SANANDAJ_TEXT', 			'TXT_KEY_CITYSTATE_SANANDAJ', 			'TXT_KEY_CITYSTATE_SANANDAJ_ADJ', 			'ART_DEF_CIVILIZATION_MINOR', 	'PLAYERCOLOR_MINOR_WHITE', 			'ARTSTYLE_EUROPEAN', 		'_ASIA', 			'ASIAN', 			'MINOR_TRAIT_CULTURED',			NULL,				'UNITCLASS_WORKER' UNION ALL
SELECT 		'MINOR_CIV_BAGHCASARAY', 		'TXT_KEY_CITYSTATE_BAGHCASARAY', 		'TXT_KEY_CIV5_BAGHCASARAY_TEXT', 		'TXT_KEY_CITYSTATE_BAGHCASARAY', 		'TXT_KEY_CITYSTATE_BAGHCASARAY_ADJ', 		'ART_DEF_CIVILIZATION_MINOR', 	'PLAYERCOLOR_MINOR_LIGHT_GREEN', 	'ARTSTYLE_EUROPEAN', 		'_ASIA', 			'ASIAN', 			'MINOR_TRAIT_MILITARISTIC',		NULL,				'UNITCLASS_WORKER' UNION ALL
...
UPDATE Language_en_US SET Text = REPLACE(Text, 'Requires an access to [COLOR_CYAN]Lhasa[ENDCOLOR]''s ability and an active session of [COLOR_POSITIVE_TEXT]World Congress[ENDCOLOR].[NEWLINE][NEWLINE]', '') WHERE Tag ='TXT_KEY_BUILDING_LHASA_HELP' AND EXISTS (SELECT * FROM Community WHERE Type='UCS-MW' AND Value= 1);
...
UPDATE Language_en_US SET Text = 'Special: [COLOR_WHITE]Lhasa''s ability[ENDCOLOR], [COLOR:45:150:50:255]World Congress[ENDCOLOR].[NEWLINE][NEWLINE]'||Text WHERE Tag ='TXT_KEY_BUILDING_LHASA_HELP' AND EXISTS (SELECT * FROM Community WHERE Type='UCS-MW' AND Value= 1);
--============================================--
