...
SELECT 'TXT_KEY_CSTRAIT_MINOR_CIV_LONGYAN', 			'[COLOR_MAGENTA]Home of Generals:[ENDCOLOR][NEWLINE]' UNION ALL
...
SELECT 		'BUILDING_SANAA', 				'BUILDINGCLASS_SAMARKAND', 				-1, 	0, 					NULL, 		'TXT_KEY_CITYSTATE_SAMARKAND', 				'TXT_KEY_CSTRAIT_MINOR_CIV_SAMARKAND', 			-1, 			1, 			0, 				1, 				5, 					'UCS_BUILDING_ATLAS', 			1, 				1,			-1 UNION ALL
...
UPDATE Improvements SET HillsMakesValid = 1, CITY???, DefenseModifier = 30 WHERE Type = 'IMPROVEMENT_TULOU';
