...
SELECT 'TXT_KEY_CSTRAIT_MINOR_CIV_DAKKAR', 				'[COLOR_MAGENTA]The Conquest of Abyssinia:[ENDCOLOR][NEWLINE]' UNION ALL
...
SELECT 'TXT_KEY_CSTRAIT_MINOR_CIV_LAHORE', 				'[COLOR_MAGENTA]Khalsa:[ENDCOLOR][NEWLINE]' UNION ALL
...
SELECT 'TXT_KEY_CSTRAIT_MINOR_CIV_OUIDAH', 				'[COLOR_MAGENTA]Slave Coast:[ENDCOLOR][NEWLINE]' UNION ALL
...
SELECT 		'MINOR_CIV_DAKKAR', 			'TXT_KEY_CITYSTATE_DAKKAR', 			'TXT_KEY_CIV5_DAKKAR_TEXT', 			'TXT_KEY_CITYSTATE_DAKKAR', 			'TXT_KEY_CITYSTATE_DAKKAR_ADJ', 			'ART_DEF_CIVILIZATION_MINOR', 	'PLAYERCOLOR_MINOR_WHITE', 			'ARTSTYLE_MIDDLE_EAST', 	'_AFRI', 			'AFRICAN', 			'MINOR_TRAIT_MARITIME',			'UNITCLASS_WORKER' UNION ALL
...
SELECT 		'MINOR_CIV_HONIARA', 			'TXT_KEY_CITYSTATE_HONIARA', 			'TXT_KEY_CIV5_HONIARA_TEXT', 			'TXT_KEY_CITYSTATE_HONIARA', 			'TXT_KEY_CITYSTATE_HONIARA_ADJ', 			'ART_DEF_CIVILIZATION_MINOR', 	'PLAYERCOLOR_MINOR_WHITE', 			'ARTSTYLE_MIDDLE_EAST', 	'_AFRI', 			'AFRICAN', 			'MINOR_TRAIT_MARITIME',			'UNITCLASS_WORKER' UNION ALL
...
SELECT 		'MINOR_CIV_KARASJOHKA', 			'TXT_KEY_CITYSTATE_KARASJOHKA', 			'TXT_KEY_CIV5_KARASJOHKA_TEXT', 			'TXT_KEY_CITYSTATE_KARASJOHKA', 			'TXT_KEY_CITYSTATE_KARASJOHKA_ADJ', 			'ART_DEF_CIVILIZATION_MINOR', 	'PLAYERCOLOR_MINOR_WHITE', 			'ARTSTYLE_MIDDLE_EAST', 	'_AFRI', 			'AFRICAN', 			'MINOR_TRAIT_MARITIME',			'UNITCLASS_WORKER' UNION ALL
...
SELECT 		'MINOR_CIV_KATENDE', 			'TXT_KEY_CITYSTATE_KATENDE', 			'TXT_KEY_CIV5_KATENDE_TEXT', 			'TXT_KEY_CITYSTATE_KATENDE', 			'TXT_KEY_CITYSTATE_KATENDE_ADJ', 			'ART_DEF_CIVILIZATION_MINOR', 	'PLAYERCOLOR_MINOR_WHITE', 			'ARTSTYLE_MIDDLE_EAST', 	'_AFRI', 			'AFRICAN', 			'MINOR_TRAIT_MARITIME',			'UNITCLASS_WORKER' UNION ALL
...
SELECT 		'MINOR_CIV_LAHORE', 			'TXT_KEY_CITYSTATE_LAHORE', 			'TXT_KEY_CIV5_LAHORE_TEXT', 			'TXT_KEY_CITYSTATE_LAHORE', 			'TXT_KEY_CITYSTATE_LAHORE_ADJ', 			'ART_DEF_CIVILIZATION_MINOR', 	'PLAYERCOLOR_MINOR_WHITE', 			'ARTSTYLE_MIDDLE_EAST', 	'_AFRI', 			'AFRICAN', 			'MINOR_TRAIT_MARITIME',			'UNITCLASS_WORKER' UNION ALL
...
SELECT 		'MINOR_CIV_OUIDAH', 			'TXT_KEY_CITYSTATE_OUIDAH', 			'TXT_KEY_CIV5_OUIDAH_TEXT', 			'TXT_KEY_CITYSTATE_OUIDAH', 			'TXT_KEY_CITYSTATE_OUIDAH_ADJ', 			'ART_DEF_CIVILIZATION_MINOR', 	'PLAYERCOLOR_MINOR_WHITE', 			'ARTSTYLE_MIDDLE_EAST', 	'_AFRI', 			'AFRICAN', 			'MINOR_TRAIT_MARITIME',			'UNITCLASS_WORKER' UNION ALL
SELECT 		'MINOR_CIV_PELYM', 			'TXT_KEY_CITYSTATE_PELYM', 			'TXT_KEY_CIV5_PELYM_TEXT', 			'TXT_KEY_CITYSTATE_PELYM', 			'TXT_KEY_CITYSTATE_PELYM_ADJ', 			'ART_DEF_CIVILIZATION_MINOR', 	'PLAYERCOLOR_MINOR_WHITE', 			'ARTSTYLE_MIDDLE_EAST', 	'_AFRI', 			'AFRICAN', 			'MINOR_TRAIT_MARITIME',			'UNITCLASS_WORKER' UNION ALL
...
SELECT 		'MINOR_CIV_POKROVKA', 			'TXT_KEY_CITYSTATE_POKROVKA', 			'TXT_KEY_CIV5_POKROVKA_TEXT', 			'TXT_KEY_CITYSTATE_POKROVKA', 			'TXT_KEY_CITYSTATE_POKROVKA_ADJ', 			'ART_DEF_CIVILIZATION_MINOR', 	'PLAYERCOLOR_MINOR_WHITE', 			'ARTSTYLE_MIDDLE_EAST', 	'_AFRI', 			'AFRICAN', 			'MINOR_TRAIT_MARITIME',			'UNITCLASS_WORKER' UNION ALL
...
SELECT 		'MINOR_CIV_SARNATH', 			'TXT_KEY_CITYSTATE_SARNATH', 			'TXT_KEY_CIV5_SARNATH_TEXT', 			'TXT_KEY_CITYSTATE_SARNATH', 			'TXT_KEY_CITYSTATE_SARNATH_ADJ', 			'ART_DEF_CIVILIZATION_MINOR', 	'PLAYERCOLOR_MINOR_WHITE', 			'ARTSTYLE_MIDDLE_EAST', 	'_AFRI', 			'AFRICAN', 			'MINOR_TRAIT_MARITIME',			'UNITCLASS_WORKER' UNION ALL
...
SELECT 		'MINOR_CIV_SUCEAVA', 			'TXT_KEY_CITYSTATE_SUCEAVA', 			'TXT_KEY_CIV5_SUCEAVA_TEXT', 			'TXT_KEY_CITYSTATE_SUCEAVA', 			'TXT_KEY_CITYSTATE_SUCEAVA_ADJ', 			'ART_DEF_CIVILIZATION_MINOR', 	'PLAYERCOLOR_MINOR_WHITE', 			'ARTSTYLE_MIDDLE_EAST', 	'_AFRI', 			'AFRICAN', 			'MINOR_TRAIT_MARITIME',			'UNITCLASS_WORKER' UNION ALL
...
SELECT 		'MINOR_CIV_TBILISI', 			'TXT_KEY_CITYSTATE_TBILISI', 			'TXT_KEY_CIV5_TBILISI_TEXT', 			'TXT_KEY_CITYSTATE_TBILISI', 			'TXT_KEY_CITYSTATE_TBILISI_ADJ', 			'ART_DEF_CIVILIZATION_MINOR', 	'PLAYERCOLOR_MINOR_WHITE', 			'ARTSTYLE_MIDDLE_EAST', 	'_AFRI', 			'AFRICAN', 			'MINOR_TRAIT_MARITIME',			'UNITCLASS_WORKER' UNION ALL
...
SELECT 		'PROMOTION_CLERMONT2', 						'TXT_KEY_PROMOTION_CLERMONT2', 				'TXT_KEY_PROMOTION_CLERMONT2_HELP', 			1, 				'AS2D_IF_LEVELUP', 	3, 				'UCS_PROMOTION_ATLAS',	'PEDIA_SHARED', 	'TXT_KEY_PROMOTION_CLERMONT2' UNION ALL
SELECT 		'PROMOTION_CLERMONT3', 						'TXT_KEY_PROMOTION_CLERMONT3', 				'TXT_KEY_PROMOTION_CLERMONT3_HELP', 			1, 				'AS2D_IF_LEVELUP', 	4, 				'UCS_PROMOTION_ATLAS', 	'PEDIA_SHARED', 	'TXT_KEY_PROMOTION_CLERMONT3' UNION ALL
SELECT 		'PROMOTION_CLERMONT4', 						'TXT_KEY_PROMOTION_CLERMONT4', 				'TXT_KEY_PROMOTION_CLERMONT4_HELP', 			1, 				'AS2D_IF_LEVELUP', 	5, 				'UCS_PROMOTION_ATLAS', 	'PEDIA_SHARED', 	'TXT_KEY_PROMOTION_CLERMONT4' UNION ALL
...
UPDATE UnitPromotions SET AttackMod = 5, RangedAttackMod = 5 WHERE Type = 'PROMOTION_KARASJOHKA';
...
UPDATE UnitPromotions SET DefenseMod = 10, ???HP WHERE Type = 'PROMOTION_SIKH_CHAINMAIL';
...
UPDATE UnitPromotions SET PromotionOrs1 = 'PROMOTION_SIKH' WHERE Type = 'PROMOTION_SIKH_SWORD';
UPDATE UnitPromotions SET PromotionOrs1 = 'PROMOTION_SIKH_SWORD' WHERE Type = 'PROMOTION_SIKH_KNIFE';
UPDATE UnitPromotions SET PromotionOrs1 = 'PROMOTION_SIKH_KNIFE' WHERE Type = 'PROMOTION_SIKH_DISC';
UPDATE UnitPromotions SET PromotionOrs1 = 'PROMOTION_SIKH_DISC' WHERE Type = 'PROMOTION_SIKH_DAGGER';
UPDATE UnitPromotions SET PromotionOrs1 = 'PROMOTION_SIKH_DISC' WHERE Type = 'PROMOTION_SIKH_TRIDENT';
UPDATE UnitPromotions SET PromotionOrs1 = 'PROMOTION_SIKH_KNIFE' WHERE Type = 'PROMOTION_SIKH_BOW';
UPDATE UnitPromotions SET PromotionOrs1 = 'PROMOTION_SIKH_BOW' WHERE Type = 'PROMOTION_SIKH_MUSKET';
UPDATE UnitPromotions SET PromotionOrs1 = 'PROMOTION_SIKH' WHERE Type = 'PROMOTION_SIKH_SHIELD';
UPDATE UnitPromotions SET PromotionOrs1 = 'PROMOTION_SIKH_SHIELD' WHERE Type = 'PROMOTION_SIKH_CHAINMAIL';
UPDATE UnitPromotions SET PromotionOrs1 = 'PROMOTION_SIKH' WHERE Type = 'PROMOTION_SIKH_ROBE';
UPDATE UnitPromotions SET PromotionOrs1 = 'PROMOTION_SIKH_ROBE' WHERE Type = 'PROMOTION_SIKH_SHOES';
UPDATE UnitPromotions SET PromotionOrs1 = 'PROMOTION_SIKH_SHOES' WHERE Type = 'PROMOTION_SIKH_MARTIAL_ART';
UPDATE UnitPromotions SET PromotionOrs1 = 'PROMOTION_SIKH_ROBE' WHERE Type = 'PROMOTION_SIKH_TURBAN';
UPDATE UnitPromotions SET PromotionOrs1 = 'PROMOTION_SIKH_TURBAN' WHERE Type = 'PROMOTION_SIKH_BRACELET';
...
SELECT 		'PLAYER_EVENT_CHOICE_MINOR_CIV_DAKKAR', 			'TXT_KEY_CSTRAIT_MINOR_CIV', 	'TXT_KEY_CSTRAIT_MINOR_CIV_DAKKAR', 			3, 				1, 			0,					NULL, 					NULL, 						NULL UNION ALL
...
SELECT 		'PLAYER_EVENT_CHOICE_MINOR_CIV_KARASJOHKA', 			'TXT_KEY_CSTRAIT_MINOR_CIV', 	'TXT_KEY_CSTRAIT_MINOR_CIV_KARASJOHKA', 			3, 				1, 			0,					NULL, 					NULL, 						NULL UNION ALL
...
SELECT 		'PLAYER_EVENT_CHOICE_MINOR_CIV_KATENDE', 			'TXT_KEY_CSTRAIT_MINOR_CIV', 	'TXT_KEY_CSTRAIT_MINOR_CIV_KATENDE', 			3, 				1, 			0,					NULL, 					NULL, 						NULL UNION ALL
...
SELECT 		'PLAYER_EVENT_CHOICE_MINOR_CIV_OUIDAH', 			'TXT_KEY_CSTRAIT_MINOR_CIV', 	'TXT_KEY_CSTRAIT_MINOR_CIV_OUIDAH', 			3, 				1, 			0,					NULL, 					NULL, 						NULL UNION ALL
...
SELECT 		'PLAYER_EVENT_CHOICE_MINOR_CIV_PELYM', 			'TXT_KEY_CSTRAIT_MINOR_CIV', 	'TXT_KEY_CSTRAIT_MINOR_CIV_PELYM', 			3, 				1, 			0,					NULL, 					NULL, 						NULL UNION ALL
...
SELECT 		'PLAYER_EVENT_CHOICE_MINOR_CIV_POKROVKA', 			'TXT_KEY_CSTRAIT_MINOR_CIV', 	'TXT_KEY_CSTRAIT_MINOR_CIV_POKROVKA', 			3, 				1, 			0,					NULL, 					NULL, 						NULL UNION ALL
...
SELECT 		'PLAYER_EVENT_CHOICE_MINOR_CIV_SARNATH', 			'TXT_KEY_CSTRAIT_MINOR_CIV', 	'TXT_KEY_CSTRAIT_MINOR_CIV_SARNATH', 			3, 				1, 			0,					NULL, 					NULL, 						NULL UNION ALL
...
SELECT 		'PLAYER_EVENT_CHOICE_MINOR_CIV_SUCEAVA', 			'TXT_KEY_CSTRAIT_MINOR_CIV', 	'TXT_KEY_CSTRAIT_MINOR_CIV_SUCEAVA', 			3, 				1, 			0,					NULL, 					NULL, 						NULL UNION ALL
...
SELECT 		'PLAYER_EVENT_CHOICE_MINOR_CIV_TBILISI', 			'TXT_KEY_CSTRAIT_MINOR_CIV', 	'TXT_KEY_CSTRAIT_MINOR_CIV_TBILISI', 			3, 				1, 			0,					NULL, 					NULL, 						NULL UNION ALL
