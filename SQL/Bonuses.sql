...
SELECT 'TXT_KEY_CSTRAIT_MINOR_CIV_ANTWERP', 			'[COLOR_MAGENTA]Economic Prominence:[ENDCOLOR] Merchants gain +1 [ICON_GOLD] Gold. Cities gain -10% [ICON_GOLD] Gold Purchase Cost.[NEWLINE]' UNION ALL
